...
'Importing required libraries for running the program'
import pandas as pd
...
class StockPredictions:
    'This class contains the prediction algorithm which helps in stock prediction'
    def main():
        start = '2010-01-01'
        end = '2020-12-31'

        st.title('Stock Tend Prediction')
